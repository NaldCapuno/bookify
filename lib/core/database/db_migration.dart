    ...
    onCreate: (Migrator m) async {
      ...
      await db.batch((batch) {
        batch.insertAll(db.accounts, [
          ...
          // ==============================
          // Current Assets (11)
          AccountsCompanion.insert(code: 101, name: 'Cash on Hand', categoryId: 11),
          AccountsCompanion.insert(code: 102, name: 'Cash in Bank - Checking', categoryId: 11),
          AccountsCompanion.insert(code: 103, name: 'Cash in Bank - Savings', categoryId: 11),
          AccountsCompanion.insert(code: 104, name: 'Petty Cash Fund', categoryId: 11),
          AccountsCompanion.insert(code: 110, name: 'Accounts Receivable - Trade', categoryId: 11),
          ...
          AccountsCompanion.insert(code: 120, name: 'Raw Materials Inventory', categoryId: 11),
          AccountsCompanion.insert(code: 121, name: 'Work in Process Inventory', categoryId: 11),
          AccountsCompanion.insert(code: 122, name: 'Finished Goods Inventory', categoryId: 11),
          ...
          AccountsCompanion.insert(code: 133, name: 'Input VAT', categoryId: 11),
          AccountsCompanion.insert(code: 134, name: 'Creditable Withholding Tax', categoryId: 11),
          ...
          AccountsCompanion.insert(code: 153, name: 'Factory Equipment', categoryId: 12),
          AccountsCompanion.insert(code: 154, name: 'Accumulated Depreciation - Factory Equipment', categoryId: 12),
          AccountsCompanion.insert(code: 155, name: 'Machinery', categoryId: 12),
          AccountsCompanion.insert(code: 156, name: 'Accumulated Depreciation - Machinery', categoryId: 12),
          ...
          AccountsCompanion.insert(code: 200, name: 'Kikiam', categoryId: 21), // Changed from 169 to avoid unique constraint collision
          AccountsCompanion.insert(code: 201, name: 'Accounts Payable - Trade', categoryId: 21),
          AccountsCompanion.insert(code: 202, name: 'Notes Payable', categoryId: 21),
          AccountsCompanion.insert(code: 203, name: 'Accrued Salaries and Wages', categoryId: 21),
          ...
          AccountsCompanion.insert(code: 210, name: 'SSS Payable', categoryId: 21),
          AccountsCompanion.insert(code: 211, name: 'PhilHealth Payable', categoryId: 21),
          AccountsCompanion.insert(code: 212, name: 'Pag-IBIG Payable', categoryId: 21),
          AccountsCompanion.insert(code: 213, name: 'Withholding Tax Payable', categoryId: 21),
          AccountsCompanion.insert(code: 214, name: 'Expanded Withholding Tax Payable', categoryId: 21),
          AccountsCompanion.insert(code: 215, name: 'Output VAT', categoryId: 21),
          AccountsCompanion.insert(code: 216, name: 'Income Tax Payable', categoryId: 21),
          ...
          // ==============================
          // Owner's Equity (31)
          AccountsCompanion.insert(code: 301, name: 'Capital Stock - Common', categoryId: 31),
          ...
          AccountsCompanion.insert(code: 310, name: 'Retained Earnings', categoryId: 31),
          ...
          AccountsCompanion.insert(code: 401, name: 'Sales Revenue', categoryId: 41),
          AccountsCompanion.insert(code: 402, name: 'Sales Returns and Allowances', categoryId: 41),
          AccountsCompanion.insert(code: 403, name: 'Sales Discounts', categoryId: 41),
          ...
          // ==============================
          // Costs of Sale (51)
          AccountsCompanion.insert(code: 501, name: 'Raw Materials Used', categoryId: 51),
          AccountsCompanion.insert(code: 502, name: 'Direct Labor', categoryId: 51),
          AccountsCompanion.insert(code: 510, name: 'Factory Overhead - Indirect Materials', categoryId: 51),
          AccountsCompanion.insert(code: 511, name: 'Factory Overhead - Indirect Labor', categoryId: 51),
          AccountsCompanion.insert(code: 512, name: 'Factory Overhead - Utilities', categoryId: 51),
          AccountsCompanion.insert(code: 513, name: 'Factory Overhead - Rent', categoryId: 51),
          AccountsCompanion.insert(code: 514, name: 'Factory Overhead - Depreciation', categoryId: 51),
          AccountsCompanion.insert(code: 515, name: 'Factory Overhead - Insurance', categoryId: 51),
          AccountsCompanion.insert(code: 516, name: 'Factory Overhead - Repairs and Maintenance', categoryId: 51),
          ...
          AccountsCompanion.insert(code: 520, name: 'Cost of Goods Sold', categoryId: 51),

          // Operating Expense (52)
          AccountsCompanion.insert(code: 601, name: 'Salaries and Wages Expense', categoryId: 52),
          AccountsCompanion.insert(code: 602, name: 'SSS Contribution Expense', categoryId: 52),
          AccountsCompanion.insert(code: 603, name: 'PhilHealth Contribution Expense', categoryId: 52),
          AccountsCompanion.insert(code: 604, name: 'Pag-IBIG Contribution Expense', categoryId: 52),
          AccountsCompanion.insert(code: 605, name: '13th Month Pay Expense', categoryId: 52),
          AccountsCompanion.insert(code: 606, name: 'Employee Benefits Expense', categoryId: 52),
          AccountsCompanion.insert(code: 610, name: 'Office Supplies Expense', categoryId: 52),
          AccountsCompanion.insert(code: 611, name: 'Utilities Expense - Office', categoryId: 52),
          ...
          AccountsCompanion.insert(code: 614, name: 'Depreciation Expense - Office', categoryId: 52),
          AccountsCompanion.insert(code: 615, name: 'Repairs and Maintenance Expense - Office', categoryId: 52),
          AccountsCompanion.insert(code: 616, name: 'Communication Expense', categoryId: 52),
          AccountsCompanion.insert(code: 617, name: 'Transportation Expense', categoryId: 52),
          AccountsCompanion.insert(code: 618, name: 'Professional Fees', categoryId: 52),
          ...
          AccountsCompanion.insert(code: 621, name: 'Bank Charges', categoryId: 52),
          AccountsCompanion.insert(code: 622, name: 'Taxes and Licenses', categoryId: 52),
          ...
          AccountsCompanion.insert(code: 628, name: 'Miscellaneous Expense', categoryId: 52),
          AccountsCompanion.insert(code: 651, name: 'Advertising Expense', categoryId: 52),
          AccountsCompanion.insert(code: 652, name: 'Sales Commission Expense', categoryId: 52),
          AccountsCompanion.insert(code: 653, name: 'Delivery Expense', categoryId: 52),
          ...
          AccountsCompanion.insert(code: 657, name: 'Freight Out', categoryId: 52),

          // Other Expense (53)
          AccountsCompanion.insert(code: 701, name: 'Interest Expense', categoryId: 53),
          ...
          AccountsCompanion.insert(code: 801, name: 'Income Tax Expense', categoryId: 53),
        ]);
      });
    },
