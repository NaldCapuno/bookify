...
import 'tables/system_tags_table.dart';
...
MigrationStrategy buildMigrationStrategy(AppDatabase db) {
  return MigrationStrategy(
    onCreate: (Migrator m) async {
      ...
      // 1. Populate the UI System Tags
      await db.batch((batch) {
        batch.insertAll(db.systemTags, [
          SystemTagsCompanion.insert(id: const Value(1), code: 'CASH', displayName: 'Physical Cash', description: const Value('Petty cash and cash on hand')),
          SystemTagsCompanion.insert(id: const Value(2), code: 'BANK', displayName: 'Banks & E-Wallets', description: const Value('GCash, Maya, and traditional bank accounts')),
          SystemTagsCompanion.insert(id: const Value(3), code: 'RAW_MAT', displayName: 'Raw Materials', description: const Value('Ingredients and packaging for production')),
          SystemTagsCompanion.insert(id: const Value(4), code: 'FIN_GOODS', displayName: 'Finished Goods', description: const Value('Products ready for sale')),
          SystemTagsCompanion.insert(id: const Value(5), code: 'PAYABLE', displayName: 'Payables & Debt', description: const Value('Money owed to suppliers or government')),
          SystemTagsCompanion.insert(id: const Value(6), code: 'REVENUE', displayName: 'Sales & Revenue', description: const Value('Income channels')),
          SystemTagsCompanion.insert(id: const Value(7), code: 'OP_EXPENSE', displayName: 'Operating Expenses', description: const Value('Day-to-day business costs')),
        ]);
      });

      // 2. Populate the accountCategories table (Unchanged)
      await db.batch((batch) {
      ...
      // 3. Populate Accounts (Now injecting systemTagId to target specific accounts)
      await db.batch((batch) {
        batch.insertAll(db.accounts, [
          // Current Assets
          AccountsCompanion.insert(code: 1110, name: 'Cash on Hand', description: const Value(''), categoryId: 111, systemTagId: const Value(1), isLocked: const Value(true)),
          AccountsCompanion.insert(code: 1111, name: 'Petty Cash Fund', description: const Value('Small bills for daily minor expenses'), categoryId: 111, systemTagId: const Value(1)),
          
          AccountsCompanion.insert(code: 1120, name: 'Cash in Bank', description: const Value(''), categoryId: 112, systemTagId: const Value(2)),
          AccountsCompanion.insert(code: 1123, name: 'GCash Wallet', description: const Value('Business GCash account for receiving payments'), categoryId: 112, systemTagId: const Value(2)),
          AccountsCompanion.insert(code: 1121, name: 'BDO Checking Account', description: const Value('Issuance of post-dated checks'), categoryId: 112, systemTagId: const Value(2)),
          AccountsCompanion.insert(code: 1122, name: 'BPI Savings Account', description: const Value('Main depository account'), categoryId: 112, systemTagId: const Value(2)),
          AccountsCompanion.insert(code: 1124, name: 'Maya Wallet', description: const Value('Business Maya account'), categoryId: 112, systemTagId: const Value(2)),
          ...
          AccountsCompanion.insert(code: 1160, name: 'Raw Materials Inventory', description: const Value(''), categoryId: 116, systemTagId: const Value(3)),
          AccountsCompanion.insert(code: 1161, name: 'Meat & Poultry Inventory', description: const Value('Raw meat for curing/processing'), categoryId: 116, systemTagId: const Value(3)),
          AccountsCompanion.insert(code: 1162, name: 'Sugar & Dairy Inventory', description: const Value('Condensed milk, sugar, and base ingredients'), categoryId: 116, systemTagId: const Value(3)),
          AccountsCompanion.insert(code: 1163, name: 'Packaging Materials Inventory', description: const Value('Jars, seals, labels, and vacuum bags'), categoryId: 116, systemTagId: const Value(3)),
          
          AccountsCompanion.insert(code: 1170, name: 'Finished Goods Inventory', description: const Value(''), categoryId: 117, systemTagId: const Value(4)),
          AccountsCompanion.insert(code: 1171, name: 'Consigned Goods Inventory', description: const Value('Products placed in local pasalubong centers or stores'), categoryId: 117, systemTagId: const Value(4)),
          ...
          // Liabilities
          AccountsCompanion.insert(code: 2110, name: 'Accounts Payable', description: const Value(''), categoryId: 211, systemTagId: const Value(5)),
          AccountsCompanion.insert(code: 2111, name: 'SSS Premium Payable', description: const Value('Employee and Employer SSS contributions'), categoryId: 211, systemTagId: const Value(5)),
          AccountsCompanion.insert(code: 2112, name: 'PhilHealth Premium Payable', description: const Value('Health contributions'), categoryId: 211, systemTagId: const Value(5)),
          AccountsCompanion.insert(code: 2113, name: 'Pag-IBIG Premium Payable', description: const Value('HDMF contributions'), categoryId: 211, systemTagId: const Value(5)),
          AccountsCompanion.insert(code: 2114, name: 'Withholding Tax Expanded (EWT)', description: const Value('Taxes withheld from rent or professionals (Form 0619-E)'), categoryId: 211, systemTagId: const Value(5)),
          AccountsCompanion.insert(code: 2115, name: 'Output VAT', description: const Value('VAT collected from sales'), categoryId: 211, systemTagId: const Value(5)),
          AccountsCompanion.insert(code: 2210, name: 'Bank Loan', description: const Value(''), categoryId: 221, systemTagId: const Value(5)),
          AccountsCompanion.insert(code: 2211, name: 'Vehicle Auto Loan', description: const Value('Long term loan for delivery trike/van'), categoryId: 221, systemTagId: const Value(5)),
          ...
          // Revenue
          AccountsCompanion.insert(code: 4110, name: 'Sales Revenue', description: const Value(''), categoryId: 411, systemTagId: const Value(6)),
          AccountsCompanion.insert(code: 4111, name: 'Wholesale Revenue', description: const Value('Bulk orders to resellers'), categoryId: 411, systemTagId: const Value(6)),
          AccountsCompanion.insert(code: 4112, name: 'Retail Revenue', description: const Value('Direct to consumer sales'), categoryId: 411, systemTagId: const Value(6)),
          AccountsCompanion.insert(code: 4113, name: 'Delivery Fees Collected', description: const Value('Shipping fees charged to customers'), categoryId: 411, systemTagId: const Value(6)),
          ...
          AccountsCompanion.insert(code: 5211, name: 'Freight Out', description: const Value(''), categoryId: 521, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5212, name: 'Advertising Expense', description: const Value(''), categoryId: 521, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5213, name: 'Sales Commission Expense', description: const Value(''), categoryId: 521, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5214, name: 'Sales Salaries Expense', description: const Value(''), categoryId: 521, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5215, name: 'Marketing Expense', description: const Value(''), categoryId: 521, systemTagId: const Value(7)),
          
          AccountsCompanion.insert(code: 5220, name: 'Salaries and Wages Expense', description: const Value(''), categoryId: 522, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5221, name: '13th Month Pay Expense', description: const Value('Mandatory year-end bonus'), categoryId: 522, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5222, name: 'Employer Contributions', description: const Value('Employer share of SSS, PhilHealth, Pag-IBIG'), categoryId: 522, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5223, name: 'Representation Expense', description: const Value('Meals and meetings with clients'), categoryId: 522, systemTagId: const Value(7)),

          AccountsCompanion.insert(code: 5231, name: 'Transportation Expense', description: const Value(''), categoryId: 523, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5232, name: 'Insurance Expense', description: const Value(''), categoryId: 523, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5233, name: 'Office Supplies Expense', description: const Value(''), categoryId: 523, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5234, name: 'Utilities Expense', description: const Value(''), categoryId: 523, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5235, name: 'Rent Expense', description: const Value(''), categoryId: 523, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5236, name: 'Miscellaneous Expense', description: const Value(''), categoryId: 523, systemTagId: const Value(7)),

          AccountsCompanion.insert(code: 5240, name: 'Repairs and Maintenance Expense', description: const Value(''), categoryId: 524, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5241, name: 'Vehicle Maintenance', description: const Value('Repairs and oil changes for delivery trike/van'), categoryId: 524, systemTagId: const Value(7)),
          
          AccountsCompanion.insert(code: 5250, name: 'Professional Fees', description: const Value(''), categoryId: 525, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5251, name: 'Retainer Fee - Bookkeeper', description: const Value('Monthly accounting services'), categoryId: 525, systemTagId: const Value(7)),
          AccountsCompanion.insert(code: 5252, name: 'Notarial Fees', description: const Value('Notary for contracts and sworn statements'), categoryId: 525, systemTagId: const Value(7)),
