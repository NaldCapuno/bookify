...
import 'views/other_actions_view.dart';
...
class QuickActionScreen extends StatelessWidget {
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildListTile(
            ...
            Icons.credit_score,
            otherTheme,
            onTap: () => _goToOther(context, "Pay your Debt"),
          ),
          _buildListTile(
            "Lend Money",
            ...
            otherTheme,
            onTap: () => _goToOther(context, "Lend Money"),
          ),
          _buildListTile(
            "Settle Operations",
            ...
            Icons.storefront,
            otherTheme,
            onTap: () => _goToOther(context, "Settle Operations"),
          ),
          _buildListTile(
            "Fund Marketing",
            ...
            otherTheme,
            onTap: () => _goToOther(context, "Fund Marketing"),
          ),
          _buildListTile(
            "Remit Taxes",
            ...
            otherTheme,
            onTap: () => _goToOther(context, "Remit Taxes"),
          ),
          _buildListTile(
            "Refund to Customers",
            ...
            otherTheme,
            onTap: () => _goToOther(context, "Refund to Customers"),
          ),
          ...
          _buildListTile(
            ...
            Icons.more_horiz,
            otherTheme,
            onTap: () => _goToOther(context, "Record Other Expense"),
          ),
  ...
  void _goToOther(BuildContext context, String title) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => OtherActionsView(title: title)),
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        _buildListTile(
          ...
          receiveTheme,
          onTap: () => _goToOther(context, "Collect Money"),
        ),
        _buildListTile(
          "Invest to Business",
          ...
          receiveTheme,
          onTap: () => _goToOther(context, "Business Investment"),
        ),
        _buildListTile(
          "Disburse funds",
          ...
          Icons.account_balance_outlined,
          receiveTheme,
          onTap: () => _goToOther(context, "Disburse Funds"),
        ),
        _buildListTile(
          "Sell Products",
