...
class _AddAccountFormState extends State<AddAccountForm> {
    ...
    showModalBottomSheet(
      ...
      builder: (context) => SafeArea(
        ...
        padding: const EdgeInsets.symmetric(
          vertical: AppInsets.formTop,
          horizontal: AppInsets.formHorizontal,
        ),
        child: Column(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    onChanged:
                        _checkCodeAvailability, // Triggers the live check
                  ...
                  TextFormField(
                    ...
                    readOnly:
                        true, // Remains true so the keyboard doesn't pop up
  ...
  Widget _buildSaveButton() {
    ...
    return ElevatedButton(
      ...
      child: _isSaving
          ...
          : Text('Save Account', style: theme.textTheme.labelLarge),
    );
  }
  ...
  Widget _buildHeader() {
    ...
    return Row(
      ...
      children: [
        Text('New Account', style: theme.textTheme.titleLarge),
        IconButton(
